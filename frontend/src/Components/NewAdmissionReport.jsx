...
const NewAdmissionReport = () => {
    const currentSatisfaction = 30;

    return (
        <div className='pb-4 bg-white rounded-xl'>
            <div>
                <div className='text-lg font-normal p-5 border-b'>New Admission Report</div>
            </div>

            <div className='flex px-4 font-normal text-base mx-5 justify-between p-4'>
                <div>
                    <span className='block text-slate-800'>Today</span>
                    <span className='flex text-lg'>118<TiArrowUpThick className='h-7 w-8  ml-0.5 text-green-700' /></span>
                </div>

                <div>
                    <span className='block text-slate-800'>This Week</span>
                    <span className='flex text-lg'>189<TiArrowDownThick className='h-7 w-8  ml-0.5 text-red-700' /></span>
                </div>

                <div>
                    <span className='block text-slate-800'>This Month</span>
                    <span className='flex text-lg'>425<TiArrowUpThick className='h-7 w-8  ml-0.5 text-green-700' /></span>
                </div>
            </div>
...
export default NewAdmissionReport;
