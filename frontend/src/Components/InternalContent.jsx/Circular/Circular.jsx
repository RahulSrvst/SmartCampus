...
const Circular = () => {
  return (
    ...
    <div className="flex items-center gap-2 md:gap-5 lg:text-lg text-sm mb-3 md:mb-8 xl:-ml-10 ">
     <span className="text-[20px]">Academic</span> <span className="text-blue-900 flex items-center text-[14px] mt-0.5" ><FaHome className="text-blue-900 w-4 h-4 mr-2" /> -  Circular</span><span className="text-[14px]  mt-0.5" > - Circular </span>
   </div>
 <div className="flex flex-wrap gap-x-4 ">
   ...
   <div className="flex justify-between text-xl font-bold mb-4 p-4 md:p-6 dark-color text-white rounded-t-lg">
     ...
     <form className="p-4">
       ...
       <label className="block mb-2">Circular Subject</label>
       ...
       <label className="block mb-2">Circular Date</label>
       <input type="text" className="w-full mb-4 p-2 border border-gray-300 rounded  " placeholder="" />

       <label className="block mb-2">Add Attachment</label>
       <input type="file" className="w-full mb-4  border border-gray-300 rounded bg-gray-100 file:outline-none file:border-none file:p-2  file:border-r  file:bg-gray-200" placeholder="" />
       
       <label className="block mb-2">Circular Content</label>
       <input type="text" className="w-full mb-4 p-2 border border-gray-300 rounded h-24 " placeholder="" />
   ...
   <div className="bg-white  shadow-md rounded-xl w-[96%] lg:w-[97%] xl:w-[50%] md:w-[96%] h-[15%] overflow-auto p-4 ">
       ...
       <table className="w-full text-sm p-3">
         <thead>
           <tr className="text-[16px] border-b border-black" >
             <th className="px-4 py-2"><div className="flex justify-between" >Sr. No</div></th>
             <th className="px-4 py-2"><div className="flex justify-between" >Circular Subject</div></th>
             <th className="px-4 py-2"><div className="flex justify-between" >Reference No.</div></th>
