...
const Attendees = () => {
  return (
    ...
    <div className="flex items-center gap-2 md:gap-5 lg:text-lg text-sm mb-3 md:mb-8 xl:-ml-10 ">
     <span className="text-[20px]">Academic</span> <span className="text-blue-900 flex items-center text-[14px] mt-0.5" ><FaHome className="text-blue-900 w-4 h-4 mr-2" /> -  Placements</span><span className="text-[14px]  mt-0.5" > - Attendees</span>
   </div>
 <div className="flex flex-wrap gap-x-4 ">
   ...
   <div className="flex justify-between text-xl font-bold  p-4 md:p-6 dark-color text-white rounded-t-lg">
         <h2>Placement Attendees List</h2>
         <BsThreeDotsVertical />
       </div>
