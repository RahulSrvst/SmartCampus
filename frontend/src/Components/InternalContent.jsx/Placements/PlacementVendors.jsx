...
const PlacementVendors = () => {
  return (
    ...
    <div className="flex items-center gap-2 md:gap-5 lg:text-lg text-sm mb-3 md:mb-8 xl:-ml-10 ">
     <span className="text-[20px]">Academic</span> <span className="text-blue-900 flex items-center text-[14px] mt-0.5" ><FaHome className="text-blue-900 w-4 h-4 mr-2" /> -  Placements</span><span className="text-[14px]  mt-0.5" > - Placement Vendors</span>
   </div>
 <div className="flex flex-wrap gap-x-4 ">
   ...
   <div className="flex justify-between text-xl font-bold mb-4 p-4 md:p-6 dark-color text-white rounded-t-lg">
     ...
     <form className="p-4">
       ...
       <label className="block mb-2">Vacancy</label><select className="w-full mb-4 p-2 border border-gray-300 rounded">
         <option>Please Select</option>
         <option>BCA</option>
         <option>MCA</option>
       </select>
       ...
       <label className="block mb-2">Program Description</label>
       <input type="number" className="w-full mb-4 p-2 border border-gray-300 rounded" placeholder="" />
       
       <label className="block mb-2">Placement Program Date</label>
       <input type="" className="w-full mb-4 p-2 border border-gray-300 rounded" placeholder="" />
...
export default PlacementVendors;
