...
function ExamGroups() {
  ...
  return (
    ...
    <div className="flex items-center gap-2 md:gap-5 lg:text-lg text-sm mb-3 md:mb-8 xl:-ml-2 ">
        <span className="text-[20px]">Academic</span> <span className="text-blue-900 flex items-center text-[14px] mt-0.5" ><FaHome className="text-blue-900 w-4 h-4 mr-2" /> -  Exam</span><span className="text-[14px]  mt-0.5" > - Exam Group</span>
      </div>
      <div className=" bg-white shadow-md rounded-lg w-[98%] md:w-[96%] lg:w-[95%] xl:w-[96%] mb-4">
        <div className="p-4 rounded-t-lg border-b ">
          <h1 className="text-xl font-bold">Add Exam Groups</h1>
        </div>
