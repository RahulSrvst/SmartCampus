...
function PrintAdmitCard() {
  ...
  return (
    ...
    <div className="flex items-center gap-2 md:gap-5 lg:text-lg text-sm mb-3 md:mb-8 xl:-ml-2 ">
        <span className="text-[20px]">Academic</span> <span className="text-blue-900 flex items-center text-[14px] mt-0.5" ><FaHome className="text-blue-900 w-4 h-4 mr-2" /> -  Exam</span><span className="text-[14px]  mt-0.5" > - Print Admit Card</span>
      </div>
