  ...
  return (
    <div className="ml-[5%] md:ml-[43%] lg:ml-[33%] xl:ml-[22.5%] xl:mt-[8%] md:mt-[10%] mt-[35%] h-screen" >
       <div className="flex items-center gap-2 md:gap-5 lg:text-lg text-sm mb-3 md:mb-8">
        Events <FaHome className="text-blue-900 w-4 h-4" /> - Events Type
    ...
    <div className="flex xl:flex-row flex-col gap-x-4 ">
      ...
      <div className="bg-white shadow-md rounded-lg w-[96%] md:w-[96%] lg:w-[95%] xl:w-[45%] mb-4 h-full">
        <h2 className="text-xl font-bold mb-4  p-6 border-b  rounded-t-lg">Event Type</h2>
      ...
      {/* Batch List Section */}
      <div className="bg-white  shadow-md rounded-lg w-[96%] lg:w-[96%] xl:w-[50%] mb-4">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-gray-300 border-separate">
          <thead>
            <tr>
              {['Sl. No.', 'Event Type', 'Action'].map((header) => (
