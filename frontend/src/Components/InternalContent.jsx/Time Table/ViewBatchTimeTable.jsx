...
<div className="flex items-center gap-2 md:gap-5 lg:text-lg text-sm mb-3 md:mb-8 xl:-ml-2 ">
        <span className="text-[20px]">Academic</span> <span className="text-blue-900 flex items-center text-[14px] mt-0.5" ><FaHome className="text-blue-900 w-4 h-4 mr-2" /> -  Time Table</span><span className="text-[14px]  mt-0.5" > - View Batch Time Table</span>
      </div>
      {/* Add Course Form */}
      <div className="bg-white shadow-md rounded-lg w-[96%] md:w-[96%] lg:w-[95%] xl:w-[96%] mb-4">
        <h2 className="text-xl font-bold mb-4 dark-color p-6 text-white  rounded-t-lg">View Batch Time Table</h2>
      ...
      {/* Course List Section */}
      <h2 className="text-xl font-bold  dark-color p-6 text-white  rounded-t-lg w-[96%] lg:w-[96%] xl:w-[96%] md:w-[96%] ">View Batch Time Table</h2>
...
export default ViewBatchTimeTable;
